...
import kotlinx.android.synthetic.main.fragment_t4.*
import java.io.ByteArrayOutputStream


/**
 * A simple [Fragment] subclass.
 * Use the [T4Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class T4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_t4, container, false)
